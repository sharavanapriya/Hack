                    ...
                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-3">
                        <div class="sidebar clearfix m-b-20">
                            <div class="main-block">
                                ...
                                <ul>
                                    <li><a href="#1" class="scroll active">Tickets</a></li>
                                    <li><a href="#2" class="scroll">FAQ</a></li>
                       ...
                       <div class="col-xs-12 col-sm-8 col-md-8 col-lg-6">
                        <div class="menu-widget m-b-30">
                            <div class="widget-heading">
                              ...
                              Tickets <a class="btn btn-link pull-right" data-toggle="collapse" href="#popular2" aria-expanded="true">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-12 col-lg-8">
                                            ...
                                            <div class="rest-descr">
                                                <h6><a href="#">Phase 1</a></h6>
                                                <p> Gold standard, Open Bar</p>
                                            </div>
                                            <!-- end:Description -->
                                        </div>
                                        <!-- end:col -->
                                ...
                                <div class="food-item white">
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-12 col-lg-8">
                                            ...
                                            <!-- end:Logo -->
                                            <div class="rest-descr">
                                                <h6><a href="#">Phase 2</a></h6>
                                                <p> Silver standard, two food coupons</p>
                                            </div>
                                            <!-- end:Description -->
                                        </div>
                                        <!-- end:col -->
                            ...
                            <div class="col-sm-12 col-xs-12">
                                <div class="panel">
									...
									<ol>
									<li>How much do your events cost? <br>Check above, Use coupons from TogetHer for special women discounts
									<br>
									<li>Late Entry: Entry allowed until 9pm<br>
									<li> Prior registration compulsory
									</ol>
									</div></div></div>
									<div class="row m-t-30">
                            <div class="col-sm-12 col-xs-12">
                                <div class="panel">
									...
									<ol>
									<li>Can I bring a bag? <br> Yes , bring a bag at your own discretion. Company shall not be liable for losses.
									<br>
									<li>Will there be a cloakroom on site?<br> No.
									</ol>
									</div></div></div>
									<div class="row m-t-30">
                            <div class="col-sm-12 col-xs-12">
                                <div class="panel">
									...
									For all accessibility requests and concerns contact : AccessibilityHelpDesk@together.com 
									</div></div></div>
