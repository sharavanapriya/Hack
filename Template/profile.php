...
?>
	function commentSubmit(){
		...
		$(document).ready(function(e) {
			...
			setInterval(function() {$('#comment_logs').load('logs.php?type='+type);}, 2000);
		});
      ...
      ?>
	   ...
	   $i=0;
        ...
        <form name="form" method="post" action="insert.php?pid=<?php echo $_SESSION["pid"] ?>">
            <b>CATEGORY:</b>
			<input type="radio" value="1" name="type">Safety
			<input type="radio" value="2" name="type">General
			<input type="radio" value="3" name="type">Experiences
