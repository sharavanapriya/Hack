...
<body class="home">
    <div class="site-wrapper animsition" data-animsition-in="fade-in" data-animsition-out="fade-out">
        ...
        <!-- banner part starts -->
        <section class="hero bg-image" data-image-src="images/wrap.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Food, Fun and Safety</h1>
                    <h5 class="font-white space-xs">Find restaurants, events,companies and coupons for free</h5>
                    <div class="banner-form">
                        <form class="form-inline" method="post" action="map_results.php">
                            <div class="form-group">
                                <label class="sr-only" for="exampleInputAmount">search by name,location or category</label>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-lg" name= "search" id="exampleInputAmount" placeholder="search by name"> </div>
                            </div>
                            <button onclick="location.href='restaurants.html'" type="submit" name="b12" class="btn theme-btn btn-lg">Search</button>
                        </form>
                    </div>
                    <div class="steps">
                        ...
                        <div class="step-item step2">
                            ...
                            <h4><span>2. </span>reviews and menu</h4> </div>
                        <!-- end:Step -->
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>Popular Restaurants This Month In Your City</h2>
                    <p class="lead">The easiest way to your favourite food</p>
                </div>
				 <?php
      $sql = "SELECT `product_id`, `product_name`, `address`, `pdesc`,`title`,`image`,`logo` FROM `tbl_products` WHERE 1 AND category= 'F'";
      try {
        $stmt = $DB->prepare($sql);
        $stmt->execute();
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                        <div class="food-item-wrap">
                            <div class="figure-wrap bg-image" data-image-src="images/<?php echo $products[$i]["image"] ?>.jpg">
                                <div class="distance"><i class="fa fa-pin"></i>1240m</div>
                                <div class="rating pull-left"> <?php
                if ($product_rating[0]["count"] > 0) {
                  echo " <div  style='color:white'><small>Average  <strong>" . round($product_rating[0]["score"], 2)."</div>";
                } else {
                  echo "<div  style='color:white'><small>No ratings</div></small>";
                }
                ?>
				
				
				</div>
                                <div class="review pull-right"><a href="#"><?php echo $product_rating[0]["count"] ?> reviews</a> </div>
                            </div>
                            <div class="content">
                                <h5><a href="profile.php?pid=<?php echo $products[$i]["product_id"] ?>"><?php echo $products[$i]["title"] ?></a></h5>
                                <div class="product-name"><?php echo $products[$i]["pdesc"] ?></div>
                                <div class="price-btn-block"> <span class="price">$ 15,99</span> <a href="profile.php?pid=<?php echo $products[$i]["product_id"] ?>" class="btn theme-btn-dash pull-right">Order Now</a> </div>
                            </div>
                            <div class="restaurant-block">
                                <div class="left">
                                    <a class="pull-left" href="profile.php?pid=<?php echo $products[$i]["product_id"] ?>"> <img style="height:60px; width:60px;" src="images/<?php echo $products[$i]["logo"] ?>.jpg" alt="Restaurant logo" /> </a>
                                    <div class="pull-left right-text"> <a href="#"><?php echo $products[$i]["product_name"] ?></a> <span><?php echo $products[$i]["address"] ?></span> </div>
                                </div>
	  ...
	  <?php }?>
            ...
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2> Popular Events In Your City</h2>
                    <p class="lead">One stop fun destination</p>
                </div>
				 <?php
      $sql = "SELECT `product_id`, `product_name`, `address`, `pdesc`,`title`,`image`,`logo` FROM `tbl_products` WHERE 1 AND category= 'E'";
      try {
        $stmt = $DB->prepare($sql);
        $stmt->execute();
        $products = $stmt->fetchAll();
      ...
      for ($i = 0; $i < count($products); $i++) {
		...
		<div class="row">
                ...
                ?></div>
                            ...
                            <div class="content">
                                <h5><a href="profile_e.php?pid=<?php echo $products[$i]["product_id"] ?>"><?php echo $products[$i]["title"] ?></a></h5>
                                <div class="product-name"><?php echo $products[$i]["pdesc"] ?></div>
                                <div class="price-btn-block"> <span class="price">$ 15,99</span> <a href="profile_e.php?pid=<?php echo $products[$i]["product_id"]?>" class="btn theme-btn-dash pull-right">Order Now</a> </div>
                            </div>
                            <div class="restaurant-block">
                                <div class="left">
                                    <a class="pull-left" href="profile_e.php?pid=<?php echo $products[$i]["product_id"] ?>"> <img style="height:60px; width:60px;" src="images/<?php echo $products[$i]["logo"] ?>.jpg" alt="Restaurant logo" /> </a>
                                    <div class="pull-left right-text"> <a href="profile_e.php?pid=<?php echo $products[$i]["product_id"] ?>"><?php echo $products[$i]["product_name"] ?></a> <span><?php echo $products[$i]["address"] ?></span> </div>
                                </div>
                                <div class="right-like-part pull-right"> <i class="fa fa-heart-o"></i> <span>48</span> </div>
                            </div>
                        </div>
            ...
            <div class="container">
                    ...
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <h3>Connect to other women</h3>
                                    <p>Large network of like minded women sharing views</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <h3>Rate Places</h3>
                                <p>Help other women gauge the safety , Car pool together to events with our new features!</p>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <h3>Get Benefits</h3>
                                <p>Get your food delivered!Get Coupons and Discounts! Exclusive Career Options for women!</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <p class="pay-info">Register for FREE now!</p>
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-5 join-text">
                                <p>Join the thousands of other restaurants who benefit from having their menus on <a href="#"><strong> TogetHer directory</strong></a> </p>
                            </div>
                            <div class="col-xs-12 col-sm-4 join-btn text-xs-right"><a href="#" class="btn theme-btn btn-lg">I‘m an organisation</a> </div>
                        </div>
                    </div>
                </section>
                <!-- add restaurant ends -->
            ...
            <div class="container">
                ...
                <div class="row top-footer">
                    <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                        <a href="#"> <img src="images/foodlogo.png" alt="Footer logo"> </a> <span>Order Delivery &amp; Take-Out </span> </div>
