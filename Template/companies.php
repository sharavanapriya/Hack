...
<body>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-7 col-md-7 col-lg-9">
							...
							<?php
	$sql="SELECT * FROM tbl_products where category = 'C'";
	...
	while($products=mysql_fetch_array($result_set))
	{
		?>
                                <div class="row">
                                    <div class="col-sm-12 col-md-12 col-lg-8 text-xs-center text-sm-left">
                                        <div class="entry-logo">
                                            <a class="img-fluid" href="company.php?pid=<?php echo $products[$i]["product_id"] ?>"><img src="images/<?php echo $products[$i]["image"] ?>.jpg" alt="Food logo"></a>
                                        </div>
                                        <!-- end:Logo -->
                                        <div class="entry-dscr">
                                            <h5><a href="#"><?php echo $products[$i]["title"] ?></a></h5> <span><?php echo $products[$i]["pdesc"] ?> <a href="company.php?pid=<?php echo $products[$i]["product_id"] ?>">...</a></span>
                ...
                ?> </div>
                                                <p> 245 Reviews</p> <a href="company.php?pid=<?php echo $products[$i]["product_id"] ?>" class="btn theme-btn-dash">View Menu</a> </div>
                                        </div>
                                        <!-- end:right info -->
                                    </div>
                                </div>
